...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.lateralTuning.pid.kf = 0.00007  # 0.00006 conservative feed-forward
    ...
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[1.1, 0.37], [0.33, 0.11]] # 2.5 mod
      else:
      ...
      if eps_modified:
        ...
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[1.1, 0.3], [0.33, 0.1]] #tuned with Titanminer
      else:
