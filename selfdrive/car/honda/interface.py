...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.lateralTuning.pid.kf = 0.000065  # conservative feed-forward
    ...
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.3], [0.1]] # modded fam put your values here
      else:
      ...
      ret.steerRatio = 15.38  # 10.93 is end-to-end spec
      if eps_modified:
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 1992, 8000], [0, 1992, 3840]] 
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.2666666], [0.08]] #my mod <--- kirils step max calculator 3x 
      else:
